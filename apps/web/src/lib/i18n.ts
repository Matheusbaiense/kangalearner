...
export const t = {
  en: {
    ...
    accountProfileSaveFailed: "Could not save profile. Please try again.",
    ...
    accountPreferencesSaveFailed: "Could not save preferences. Please try again.",
  ...
  pt: {
    ...
    accountProfileSaveFailed: "Não foi possível salvar o perfil. Tente novamente.",
    ...
    accountPreferencesSaveFailed: "Não foi possível salvar as preferências. Tente novamente.",
  ...
  es: {
    ...
    accountProfileSaveFailed: "No se pudo guardar el perfil. Inténtalo de nuevo.",
    ...
    accountPreferencesSaveFailed: "No se pudieron guardar las preferencias. Inténtalo de nuevo.",
