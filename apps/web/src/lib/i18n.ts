...
export const t = {
  en: {
    ...
    practice: "Practice",
    retry: "Retry",
    syncSaveFailed: "Could not save. Try again.",
    dashLoadFailed: "Could not load your progress. Try again.",
    accountLoadFailed: "Could not load your account. Try again.",
    ...
    accountSecuritySub: "Update your password. You must enter the current one first.",
    accountCurrentPassword: "Current password",
    accountCurrentPasswordPlaceholder: "Your current password",
    accountReauthRequired: "Enter your current password to continue.",
    accountPasswordChangeFailed: "Could not change password. Please try again.",
    accountOauthPasswordHint: "Signed in with Google? Create a password first via",
    ...
    accountDeletePasswordLabel: "Confirm with your current password",
  ...
  pt: {
    ...
    syncSaveFailed: "Não foi possível guardar. Tentar de novo.",
    dashLoadFailed: "Não foi possível carregar o teu progresso. Tentar de novo.",
    accountLoadFailed: "Não foi possível carregar a conta. Tentar de novo.",
    ...
    accountSecuritySub: "Atualize sua senha. É preciso informar a senha atual primeiro.",
    accountCurrentPassword: "Senha atual",
    accountCurrentPasswordPlaceholder: "Sua senha atual",
    accountReauthRequired: "Informe sua senha atual para continuar.",
    accountPasswordChangeFailed: "Não foi possível alterar a senha. Tente novamente.",
    accountOauthPasswordHint: "Entrou com o Google? Crie uma senha primeiro em",
    ...
    accountDeletePasswordLabel: "Confirme com sua senha atual",
  ...
  es: {
    ...
    practice: "Practicar",
    retry: "Reintentar",
    syncSaveFailed: "No se pudo guardar. Inténtalo de nuevo.",
    dashLoadFailed: "No se pudo cargar tu progreso. Inténtalo de nuevo.",
    accountLoadFailed: "No se pudo cargar la cuenta. Inténtalo de nuevo.",
    ...
    accountSecuritySub: "Actualiza tu contraseña. Debes introducir la actual primero.",
    accountCurrentPassword: "Contraseña actual",
    accountCurrentPasswordPlaceholder: "Tu contraseña actual",
    accountReauthRequired: "Introduce tu contraseña actual para continuar.",
    accountPasswordChangeFailed: "No se pudo cambiar la contraseña. Inténtalo de nuevo.",
    accountOauthPasswordHint: "¿Entraste con Google? Crea una contraseña primero en",
    ...
    accountDeletePasswordLabel: "Confirma con tu contraseña actual",
