...
/**
 * Conteudo editorial por estado para as paginas SEO /learner-test/[state].
 * REGRA: numero de questoes, nota de corte, nome da prova e autoridade NAO
 * vivem aqui — vem de STATE_PROFILES (@kanga/core), que e a fonte unica usada
 * tambem pela copy de /learn e /mock-test. Duas tabelas divergiam e a pagina
 * SEO do ACT ficou sem numeros enquanto o Learn os mostrava; nao repetir.
 * Contagens do banco de perguntas tambem nao entram aqui: sao calculadas em
 * build a partir de QUESTIONS + filterByState.
 */
...
export const STATE_TEST_INFO: StateTestInfo[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      {
        q: "What score do I need to pass the ACT test?",
        a: "The test has 35 questions and you may get at most 4 wrong. Four categories allow no mistakes at all: alcohol and drugs, intersections, seat belts and vulnerable road users."
      },
      {
