      ...
      <div className="app-container">
        ...
        <p>
          {`The ${info.testName}${abbrSuffix} is the official knowledge test you must pass to get ` +
            ...
            ` The real test has ${profile.totalQuestions} questions and the pass mark is ${profile.passMarkLabel}.`}
        </p>
        <p>
        ...
        <div className="stat-grid" style={{ margin: "1.5rem 0" }}>
          ...
          <div className="stat-card">
            ...
            <div className="stat-card-value">{profile.totalQuestions} questions</div>
          </div>
          <div className="stat-card">
            <div className="stat-card-label">Pass mark</div>
            <div className="stat-card-value">{profile.passMarkLabel}</div>
          </div>
          <div className="stat-card">
