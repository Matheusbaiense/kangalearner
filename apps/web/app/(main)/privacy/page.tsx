  ...
  return (
    <main style={{ maxWidth: 720, margin: "0 auto", padding: "2rem 1.25rem", lineHeight: 1.6 }}>
      ...
      <p style={{ color: "var(--muted2, #536778)", marginBottom: "1.25rem" }}>
        This is a placeholder. We aim to collect only what is needed to run the product (e.g.
        account and practice data you choose to sync). Review your Supabase project settings and
        data processing agreements for the authoritative privacy posture. Replace this page with a
        full policy before public launch.
      </p>
      <p>
