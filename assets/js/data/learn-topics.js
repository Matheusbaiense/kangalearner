const LEARN_TOPICS = [
  {
    ...
    summary: {
      ...
      es: "El límite de velocidad es el máximo legal en condiciones ideales, no un objetivo. Debe reducir la velocidad cuando hay tráfico, lluvia, poca visibilidad, obras, peatones o ciclistas."
    },
    keyRules: [
      {
      ...
      },
      {
        ...
        es: "Reduzca la velocidad cuando la vía, el clima, la visibilidad o el tráfico no sean ideales."
      }
    ],
    mistakes: [
      {
    ...
    quickCheck: [
      ...
      },
      {
        ...
        es: "¿Por qué debe reducir la velocidad cerca de peatones y ciclistas?"
      }
    ],
    source: {
  ...
  },
  {
    ...
    icon: "parking",
    title: { pt: "Estacionamento", en: "Parking", es: "Estacionamiento" },
    summary: {
    ...
    example: {
      pt: "Você encontra uma vaga perto de uma faixa de pedestres. Antes de estacionar, verifique se há distância suficiente para não bloquear a visibilidade de quem cruza.",
    ...
    source: {
      ...
      es: "Basado en el Drive Safe Handbook — section 3.18 Parking."
    }
  },
  {
    slug: "alcohol-and-drugs",
    category: "Alcohol & BAC",
    icon: "alcohol",
    title: {
    ...
    quickCheck: [
      ...
      { pt: "Café reduz o BAC?", en: "Does coffee reduce BAC?", es: "¿El café reduce el BAC?" },
      {
  ...
  },
  {
    ...
    icon: "emergency",
    title: { pt: "Emergências na estrada", en: "Emergencies", es: "Emergencias en la carretera" },
    summary: {
      pt: "Em uma emergência, sua prioridade é manter o controle, reduzir o risco e mover pessoas para segurança. A reação deve ser calma, firme e prática.",
      en: "In an emergency, your priority is to keep control, reduce risk and move people to safety. Your response should be calm, firm and practical.",
      es: "En una emergencia, su prioridad es mantener el control, reducir el riesgo y mover a las personas a un lugar seguro. La respuesta debe ser calmada, firme y práctica."
    },
    keyRules: [
      {
        pt: "Se o acelerador travar, coloque em neutro ou acione a embreagem e freie com segurança.",
        en: "If the accelerator sticks, select neutral or press the clutch and brake safely.",
        es: "Si el acelerador se traba, ponga neutro o presione el embrague y frene con seguridad."
      },
      {
        pt: "Se os freios falharem, reduza a marcha e use o freio de mão suavemente.",
        en: "If the brakes fail, change to a lower gear and apply the handbrake gently.",
        es: "Si fallan los frenos, reduzca la marcha y use el freno de mano suavemente."
      },
      {
        pt: "Em incêndio no veículo, pare com segurança, desligue o motor e afaste as pessoas.",
        en: "If the vehicle catches fire, stop safely, turn off the engine and move people away.",
        es: "Si el vehículo se incendia, deténgase con seguridad, apague el motor y aleje a las personas."
      },
      {
        pt: "Em qualquer emergência, evite movimentos bruscos e procure um local seguro.",
        en: "In any emergency, avoid sudden movements and aim for a safe area.",
        es: "En cualquier emergencia, evite movimientos bruscos y busque un lugar seguro."
      }
    ],
    mistakes: [
      {
        pt: "Entrar em pânico e fazer movimentos bruscos.",
        en: "Panicking and making sudden movements.",
        es: "Entrar en pánico y hacer movimientos bruscos."
      },
      {
        pt: "Sair do carro sem verificar o tráfego ao redor.",
        en: "Leaving the vehicle without checking surrounding traffic.",
        es: "Salir del vehículo sin revisar el tráfico alrededor."
      }
    ],
    example: {
      pt: "Se o pneu estourar, segure o volante com firmeza, não freie bruscamente, reduza aos poucos e procure um local seguro para parar.",
      en: "If a tyre blows out, hold the steering wheel firmly, do not brake suddenly, slow down gradually and find a safe place to stop.",
      es: "Si revienta un neumático, sujete el volante firmemente, no frene de golpe, reduzca gradualmente y busque un lugar seguro para detenerse."
    },
    quickCheck: [
      {
        pt: "O que fazer se o acelerador travar?",
        en: "What should you do if the accelerator sticks?",
        es: "¿Qué debe hacer si el acelerador se traba?"
      },
      {
        pt: "Como reagir se os freios falharem?",
        en: "How should you react if the brakes fail?",
        es: "¿Cómo debe reaccionar si fallan los frenos?"
      },
      {
        pt: "Qual é a prioridade em um incêndio no veículo?",
        en: "What is the priority if your vehicle catches fire?",
        es: "¿Cuál es la prioridad si el vehículo se incendia?"
      }
    ],
    source: {
      pt: "Baseado no Drive Safe Handbook — seção 4.2 How to Handle Emergencies.",
