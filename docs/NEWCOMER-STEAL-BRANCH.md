...
| B   | **Gamificação** (XP/streak/níveis/badges)                                          | **PROD**: reverter "sem gamificação em prod" + migration `007`                          | Concluir practice/mock concede XP; streak +1/dia; badges destravam; RLS own-row        |
