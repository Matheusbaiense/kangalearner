...
- Fase 3.2 JSON-by-state, 5.3 MFA admin, 6 E2E, 7 DRY
...
1. Criar projeto Supabase **staging** (pode ser free).
2. `supabase db push` / aplicar migrations 001–030 **lá primeiro**.
