...
- [ ] **Staging environment**: projeto `kangalearner-staging` (ref `zlsaerfsrfyxpbpxorwo`) existe. 001–012 aplicadas; 013 falhou até `user_settings` ser criada na 013. Continuar 013→034 no mesmo projeto; Preview Vercel + smoke ainda em aberto.
