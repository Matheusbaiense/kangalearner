...
- [ ] **RLS regression 025**: SQL **aplicado em staging** (`kangalearner-staging`, 031–034 em 2026-08-18). **Ainda não em prod.** Dashboard só SELECT; writes via trigger 028. Bloqueado até backup 0.1 + smoke SQL-S.
...
- [~] **Staging environment**: projeto `kangalearner-staging` (ref `zlsaerfsrfyxpbpxorwo`) existe; **001–034 aplicadas** (2026-08-18). Preview Vercel + smoke SQL-S/SQL-S2 ainda em aberto.
