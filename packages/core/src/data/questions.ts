...
export const QUESTIONS = [
  ...
  },
  {
    ...
    q: {
      ...
      pt: "O que fazer ao encontrar um sinal de STOP?",
      es: "¿Qué debe hacer ante una señal de STOP?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Stop 2 metres before the sign",
          pt: "Parar 2 metros antes do sinal",
          es: "Detenerse 2 metros antes"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Stop and give way to ALL traffic on the crossroad",
          pt: "Parar e dar preferência a TODOS na via transversal",
          es: "Detenerse y ceder el paso a TODO el tráfico en la vía cruzada"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "Slow down if traffic is approaching",
          pt: "Reduzir se houver tráfego",
          es: "Reducir la velocidad si hay tráfico"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Give Way Rules",
    q: {
      en: "Turning at an intersection (no lights) with pedestrians crossing — what do you do?",
      pt: "Virando em interseção sem semáforo com pedestres atravessando?",
      es: "Girando en una intersección sin semáforos con peatones cruzando?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Give way only if turning right",
          pt: "Dar preferência apenas virando à direita",
          es: "Ceder solo al girar a la derecha"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Give way only if turning left",
          pt: "Dar preferência apenas virando à esquerda",
          es: "Ceder solo al girar a la izquierda"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Give way to pedestrians at ALL times",
          pt: "Dar preferência a pedestres SEMPRE",
          es: "Ceder el paso a peatones SIEMPRE"
        },
        ok: true
      }
    ],
  ...
  },
  {
    ...
    cat: "Give Way Rules",
    q: {
      en: "Is it an offence not to give way to an emergency vehicle?",
      pt: "É infração não dar passagem a veículo de emergência?",
      es: "¿Es una infracción no ceder el paso a un vehículo de emergencia?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Yes, only if using siren or flashing lights",
          pt: "Sim, apenas com sirene ou luzes",
          es: "Sí, solo si usa sirena o luces"
        },
        ok: false
      },
      {
  ...
  },
  {
    ...
    cat: "Parking Rules",
    q: {
      en: "Minimum distance to park from a fire hydrant?",
      pt: "Distância mínima para estacionar de um hidrante?",
      es: "¿Distancia mínima para estacionar cerca de una boca de incendio?"
    },
    sign: "",
    cap: null,
    opts: [
  ...
  },
  {
    ...
    cat: "Parking Rules",
    q: {
      en: "Minimum distance to park from a public letter box?",
      pt: "Distância mínima de uma caixa de correio pública?",
      es: "¿Distancia mínima de un buzón público?"
    },
    sign: "",
    cap: null,
    opts: [
  ...
  },
  {
    ...
    cat: "Parking Rules",
    q: {
      en: "Minimum distance to park from an intersection WITHOUT traffic lights?",
      pt: "Distância mínima de interseção SEM semáforo?",
      es: "¿Distancia mínima de una intersección SIN semáforos?"
    },
    sign: "",
    cap: null,
    opts: [
  ...
  },
  {
    ...
    cat: "Parking Rules",
    q: {
      en: "Minimum distance to park from a railway crossing?",
      pt: "Distância mínima de um cruzamento ferroviário?",
      es: "¿Distancia mínima de un paso a nivel?"
    },
    sign: "",
    cap: null,
    opts: [
    ...
    opts: [
      {
        l: "A",
        t: {
          en: "Do not exceed 60 km/h unless the road is clear",
          pt: "Não exceder 60 km/h a menos que a estrada esteja livre",
          es: "No superar los 60 km/h a menos que la carretera esté despejada"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "The recommended speed is 60 km/h",
          pt: "A velocidade recomendada é 60 km/h",
          es: "La velocidad recomendada es 60 km/h"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "Do not exceed 60 km/h at any time",
          pt: "Não exceder 60 km/h em nenhum momento",
          es: "No superar los 60 km/h en ningún momento"
        },
        ok: false
      }
    ],
    exp: {
      en: "The red <strong>dashed</strong> circle = advisory (recommended) speed — not a mandatory speed limit.",
      pt: "Borda <strong>tracejada</strong> vermelha = velocidade recomendada — não é limite obrigatório.",
      es: "Borde <strong>discontinuo</strong> rojo = velocidad recomendada — no es un límite obligatorio."
    },
    tip: null,
    states: ["WA"]
  },
  {
    ...
    cap: {
      en: "GIVE WAY sign",
      pt: "Sinal GIVE WAY",
      es: "Señal CEDA EL PASO"
    },
    opts: [
      {
        l: "A",
        t: {
          en: "Give way to traffic on the right only",
          pt: "Dar preferência apenas ao tráfego da direita",
          es: "Ceder solo a los de la derecha"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Stop and give way to all traffic",
          pt: "Parar e dar preferência a todos",
          es: "Detenerse y ceder el paso a todos"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Slow down and give way to all traffic on the intersecting road",
          pt: "Reduzir e dar preferência a todos na via que cruza",
          es: "Reducir y ceder el paso a todo el tráfico en la vía que cruza"
        },
        ok: true
      }
    ],
    exp: {
      en: "GIVE WAY = slow down and yield. <strong>Not the same as STOP</strong> — you don't have to stop if clear.",
      pt: "GIVE WAY = reduza e dê preferência. <strong>Diferente do STOP</strong> — não precisa parar se estiver livre.",
      es: "CEDA EL PASO = reduce y cede. <strong>No es igual a STOP</strong> — no necesita detenerse si está despejado."
    },
    tip: null,
    states: ["WA"]
  },
    ...
    opts: [
      {
        l: "A",
        t: {
          en: "No entry for heavy vehicles",
          pt: "Sem entrada para veículos pesados",
          es: "No pasar para vehículos pesados"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "No entry at any time",
          pt: "Sem entrada em nenhum momento",
          es: "Prohibido el paso en todo momento"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "No entry during daylight hours",
          pt: "Sem entrada durante o dia",
          es: "Prohibido el paso durante el día"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Road Signs",
    q: {
      en: "What is the meaning of this sign? (yellow diamond with + cross)",
    ...
    opts: [
      ...
      },
      {
        l: "B",
        t: {
          en: "Caution, crossroad ahead",
          pt: "Cuidado, cruzamento à frente",
          es: "Atención, cruce adelante"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "Caution, ambulance depot",
          pt: "Cuidado, depósito de ambulância",
          es: "Atención, depósito de ambulancias"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Road Signs",
    q: {
      en: "What is the meaning of this sign? (yellow circle with walking figure)",
    ...
    opts: [
      {
        l: "A",
        t: {
          en: "Caution, school ahead",
          pt: "Cuidado, escola à frente",
          es: "Atención, escuela adelante"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Caution, pedestrian crossing ahead",
          pt: "Cuidado, faixa de pedestre à frente",
          es: "Atención, paso de peatones adelante"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "Caution, traffic lights ahead",
          pt: "Cuidado, semáforo à frente",
          es: "Atención, semáforo adelante"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Road Signs",
    q: {
      en: "What is the meaning of this sign? (yellow circle with children figures)",
    ...
    cap: {
      ...
      es: "Señal de cruce de niños"
    },
    opts: [
      {
        l: "A",
        t: {
          en: "Caution, an attended children's crossing is ahead",
          pt: "Cuidado, cruzamento de crianças supervisionado à frente",
          es: "Atención, cruce de niños supervisado adelante"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "Caution, watch out for children",
          pt: "Cuidado com crianças",
          es: "Atención, niños"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Stop immediately if you see children",
          pt: "Pare imediatamente se ver crianças",
          es: "Deténgase inmediatamente si ve niños"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cap: {
      ...
      es: "Aparcamiento ACROD para discapacitados"
    },
    opts: [
      {
        l: "A",
        t: {
          en: "Reserved for people in wheelchairs only",
          pt: "Reservado apenas para cadeirantes",
          es: "Reservado solo para personas en silla de ruedas"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Reserved for emergency vehicles",
          pt: "Reservado para veículos de emergência",
          es: "Reservado para vehículos de emergencia"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Reserved for holders of a current ACROD parking permit",
          pt: "Reservado para portadores de ACROD parking permit",
          es: "Reservado para titulares del permiso ACROD"
        },
        ok: true
      }
    ],
    exp: {
      en: "Reserved for <strong>ACROD parking permit holders</strong> — broader than just wheelchair users.",
      pt: "Reservado para portadores do <strong>ACROD parking permit</strong> — mais amplo que só cadeirantes.",
      es: "Reservado para titulares del <strong>permiso ACROD</strong> — más amplio que solo sillas de ruedas."
    },
    tip: null,
    states: ["WA"]
  },
  {
    ...
    cap: {
      en: "ONE WAY sign",
      pt: "Sinal ONE WAY",
      es: "Señal SENTIDO ÚNICO"
    },
    opts: [
      {
        l: "A",
        t: {
          en: "You can only drive in the direction of the arrow",
          pt: "Pode dirigir apenas na direção da seta",
          es: "Solo puede conducir en la dirección de la flecha"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "You cannot go past the arrow",
          pt: "Não pode passar pela seta",
          es: "No puede pasar la flecha"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "You can go either way but in one lane",
          pt: "Pode ir nos dois sentidos em uma faixa",
          es: "Puede ir en ambas direcciones en un carril"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Road Signs",
    q: {
      en: "What is the meaning of this sign? (yellow diamond with curved S-arrow)",
    ...
    opts: [
      {
        l: "A",
        t: {
          en: "There is a steep hill ahead",
          pt: "Há uma subida acentuada à frente",
          es: "Hay una cuesta pronunciada adelante"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Slow down for a dip in the road",
          pt: "Reduza para uma depressão na estrada",
          es: "Reduzca la velocidad por un bache en la carretera"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Caution — the road curves right, then left",
          pt: "Cuidado — a estrada curva à direita e depois à esquerda",
          es: "Atención — la carretera curva a la derecha y luego a la izquierda"
        },
        ok: true
      }
    ],
  ...
  },
  {
    ...
    cat: "Road Safety",
    q: {
      en: "What is the first thing to do when assisting at a crash scene?",
      pt: "Primeira coisa ao ajudar em uma cena de acidente?",
      es: "¿Qué es lo primero que debe hacer al asistir en un accidente?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Remove occupants from the vehicle",
          pt: "Remover ocupantes do veículo",
          es: "Sacar a los ocupantes del vehículo"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Check whether anyone is unconscious",
          pt: "Verificar se há inconscientes",
          es: "Comprobar si hay inconscientes"
        },
        ok: false
      },
      {
        ...
        t: {
          en: "Check for danger",
          pt: "Verificar se há perigo",
          es: "Comprobar si hay peligro"
        },
        ok: true
      }
    ],
    exp: {
      en: "First: <strong>check for danger</strong>. Then check for injuries.",
      pt: "Primeiro: <strong>verificar se há perigo</strong>. Depois verificar feridos.",
      es: "Primero: <strong>comprobar si hay peligro</strong>. Luego verificar heridos."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Emergencies",
    q: {
      en: "What should you do if your accelerator is stuck?",
      pt: "O que fazer se o acelerador travar?",
      es: "¿Qué hacer si el acelerador se queda bloqueado?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Apply the clutch or select neutral and apply the brake",
          pt: "Acionar embreagem ou neutro + freio",
          es: "Embrague o neutro + freno"
        },
        ok: true
      },
      {
      ...
      },
      {
        l: "C",
        t: {
          en: "Change to a lower gear",
          pt: "Mudar para marcha menor",
          es: "Cambiar a una marcha menor"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    q: {
      ...
      pt: "O que fazer se os freios falharem?",
      es: "¿Qué hacer si fallan los frenos?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Change to lower gear and gently apply the handbrake",
          pt: "Marcha menor + freio de mão suave",
          es: "Marcha menor + freno de mano suavemente"
        },
        ok: true
      },
      {
      ...
      },
      {
        l: "C",
        t: {
          en: "Accelerate and sound the horn",
          pt: "Acelerar e buzinar",
          es: "Acelerar y tocar el claxon"
        },
        ok: false
      }
    ],
  ...
  },
  {
    ...
    cat: "Emergencies",
    q: {
      en: "What should you do if a head-on collision seems likely?",
      pt: "O que fazer se uma colisão frontal parecer inevitável?",
      es: "¿Qué hacer si parece inevitable una colisión frontal?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Apply the emergency brake",
          pt: "Aplicar o freio de emergência",
          es: "Aplicar el freno de emergencia"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Brake firmly and drive towards open ground",
          pt: "Frear com força e ir para terreno aberto",
          es: "Frenar con fuerza y dirigirse a terreno abierto"
        },
        ok: true
      },
      {
  ...
  },
  {
    ...
    cat: "Emergencies",
    q: {
      en: "What should you do if your vehicle catches fire?",
      pt: "O que fazer se o veículo pegar fogo?",
      es: "¿Qué hacer si el vehículo se incendia?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Accelerate to blow out the flames",
          pt: "Acelerar para apagar as chamas",
          es: "Acelerar para apagar las llamas"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Sound the horn to warn other drivers",
          pt: "Buzinar para avisar outros motoristas",
          es: "Tocar el claxon para avisar a otros conductores"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Stop and turn off the ignition",
          pt: "Parar e desligar o motor",
          es: "Detenerse y apagar el motor"
        },
        ok: true
      }
    ],
  ...
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "Can a learner driver use a hands-free phone while driving in WA?",
    ...
    opts: [
      {
        l: "A",
        t: {
          en: "Yes, if the phone is mounted",
          pt: "Sim, se o celular estiver no suporte",
          es: "Sí, si el teléfono está en un soporte"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Yes, for calls under one minute",
          pt: "Sim, para chamadas de menos de um minuto",
          es: "Sí, para llamadas de menos de un minuto"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "No — any mobile phone use is banned for learner drivers",
          pt: "Não — qualquer uso de celular é proibido para learners",
          es: "No — cualquier uso del móvil está prohibido para conductores learner"
        },
        ok: true
      }
    ],
    exp: {
      en: "Learner and P1/P2 drivers face a complete phone ban in WA — no calls, no texts, no hands-free, no phone GPS.",
      pt: "Motoristas learner e P1/P2 têm proibição total de celular em WA — sem chamadas, mensagens, viva-voz ou GPS no celular.",
      es: "Los conductores learner y P1/P2 tienen prohibición total del móvil en WA — sin llamadas, mensajes, manos libres ni GPS en el teléfono."
    },
    tip: null,
    states: ["WA"]
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "May a learner driver use their phone as a GPS if it is fixed in a mount?",
      pt: "Um learner pode usar o celular como GPS se ele estiver fixo no suporte?",
      es: "¿Puede un learner usar el teléfono como GPS si está fijo en un soporte?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "No — even mounted GPS use is banned for learner drivers",
          pt: "Não — mesmo no suporte, o GPS no celular é proibido para learners",
          es: "No — incluso montado, el GPS en el móvil está prohibido para learners"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "Yes, as long as they do not touch it",
          pt: "Sim, desde que não toque nele",
          es: "Sí, siempre que no lo toque"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Yes, with the sound turned off",
          pt: "Sim, com o som desligado",
          es: "Sí, con el sonido apagado"
        },
        ok: false
      }
    ],
    exp: {
      en: "The learner ban covers every use of the phone, including mounted GPS. Use a dedicated GPS device or ask a passenger to navigate.",
      pt: "A proibição para learners cobre todo uso do celular, inclusive GPS no suporte. Use um GPS dedicado ou peça a um passageiro para navegar.",
      es: "La prohibición para learners cubre todo uso del móvil, incluido el GPS montado. Use un GPS dedicado o pida a un pasajero que navegue."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "Which drivers face a total mobile phone ban — including hands-free — in WA?",
      pt: "Quais motoristas têm proibição total de celular — inclusive viva-voz — em WA?",
      es: "¿Qué conductores tienen prohibición total del móvil — incluido manos libres — en WA?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Learner and P1/P2 drivers",
          pt: "Motoristas learner e P1/P2",
          es: "Conductores learner y P1/P2"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "Only drivers of heavy vehicles",
          pt: "Apenas motoristas de veículos pesados",
          es: "Solo conductores de vehículos pesados"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "All drivers aged over 65",
          pt: "Todos os motoristas com mais de 65 anos",
          es: "Todos los conductores mayores de 65 años"
        },
        ok: false
      }
    ],
    exp: {
      en: "WA applies a complete ban to novice drivers (L and P1/P2). Full licence holders may use hands-free only, with the phone mounted.",
      pt: "WA aplica proibição total a motoristas novatos (L e P1/P2). Habilitados plenos só podem usar viva-voz, com o celular no suporte.",
      es: "WA aplica una prohibición total a los conductores novatos (L y P1/P2). Los titulares de licencia completa solo pueden usar manos libres, con el móvil en soporte."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "Where are penalties for illegal phone use doubled in WA?",
      pt: "Onde as penalidades por uso ilegal de celular dobram em WA?",
      es: "¿Dónde se duplican las sanciones por uso ilegal del móvil en WA?"
    },
    sign: "",
    cap: null,
    opts: [
      ...
      },
      {
        l: "C",
        t: {
          en: "In school zones and roadwork areas",
          pt: "Em zonas escolares e áreas de obras",
          es: "En zonas escolares y áreas de obras"
        },
        ok: true
      }
    ],
    exp: {
      en: "Phone penalties are doubled in school zones and roadwork areas — places where distracted driving is most dangerous.",
      pt: "As penalidades por celular dobram em zonas escolares e áreas de obras — locais onde a distração é mais perigosa.",
      es: "Las sanciones por el móvil se duplican en zonas escolares y áreas de obras — lugares donde la distracción es más peligrosa."
    },
    tip: null,
    states: ["WA"]
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "A learner driver needs navigation. What is a legal option in WA?",
      pt: "Um motorista learner precisa de navegação. Qual é a opção legal em WA?",
      es: "Un conductor learner necesita navegación. ¿Cuál es la opción legal en WA?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "A dedicated GPS device or a passenger navigating",
          pt: "Um GPS dedicado ou um passageiro navegando",
          es: "Un GPS dedicado o un pasajero que navegue"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "Glancing at the phone only at red lights",
          pt: "Olhar o celular apenas nos sinais vermelhos",
          es: "Mirar el móvil solo en los semáforos en rojo"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Holding the phone below the dashboard",
          pt: "Segurar o celular abaixo do painel",
          es: "Sostener el móvil debajo del tablero"
        },
        ok: false
      }
    ],
    exp: {
      en: "Learners cannot use the phone at all — mounted or not, moving or stopped. A dedicated GPS device or a navigating passenger is the legal alternative.",
      pt: "Learners não podem usar o celular de forma alguma — no suporte ou não, andando ou parado. GPS dedicado ou passageiro navegando é a alternativa legal.",
      es: "Los learners no pueden usar el móvil de ninguna forma — montado o no, en movimiento o detenido. Un GPS dedicado o un pasajero que navegue es la alternativa legal."
    },
    tip: null,
    states: ["WA"]
  },
  {
    ...
    cat: "Mobile Phones",
    q: {
      en: "Can a learner driver take calls through a Bluetooth headset?",
      pt: "Um motorista learner pode atender chamadas com fone Bluetooth?",
      es: "¿Puede un conductor learner atender llamadas con un auricular Bluetooth?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Yes, using one ear only",
          pt: "Sim, usando apenas um ouvido",
          es: "Sí, usando un solo oído"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Yes, if the call is short",
          pt: "Sim, se a chamada for curta",
          es: "Sí, si la llamada es corta"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "No — any phone use, including headsets, is banned for learners",
          pt: "Não — qualquer uso de celular, incluindo fones, é proibido para learners",
          es: "No — cualquier uso del móvil, incluidos auriculares, está prohibido para learners"
        },
        ok: true
      }
    ],
    exp: {
      en: "Hands-free and headsets are still phone use — and for learner drivers all phone use is banned in WA.",
      pt: "Viva-voz e fones ainda são uso de celular — e para learners todo uso de celular é proibido em WA.",
      es: "El manos libres y los auriculares siguen siendo uso del móvil — y para los learners todo uso está prohibido en WA."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Fatigue",
    q: {
      en: "Can driving while fatigued be treated as an offence in WA?",
      pt: "Dirigir com fadiga pode ser tratado como infração em WA?",
      es: "¿Conducir con fatiga puede tratarse como una infracción en WA?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Yes — police can act if your driving shows signs of fatigue",
          pt: "Sim — a polícia pode agir se sua direção mostrar sinais de fadiga",
          es: "Sí — la policía puede actuar si su conducción muestra signos de fatiga"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "No — fatigue is never an offence",
          pt: "Não — fadiga nunca é infração",
          es: "No — la fatiga nunca es una infracción"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Only for truck and bus drivers",
          pt: "Só para motoristas de caminhão e ônibus",
          es: "Solo para conductores de camiones y autobuses"
        },
        ok: false
      }
    ],
    exp: {
      en: "There is no legal limit for hours driven in a car, but failing to manage fatigue is an offence — police can act when your driving shows it.",
      pt: "Não há limite legal de horas ao volante para carros, mas não gerenciar a fadiga é infração — a polícia pode agir quando sua direção demonstra isso.",
      es: "No hay un límite legal de horas al volante para autos, pero no gestionar la fatiga es una infracción — la policía puede actuar cuando su conducción lo demuestra."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "School Zones",
    q: {
      en: "How do penalties in school zones compare with other roads?",
      pt: "Como as penalidades em zonas escolares se comparam às de outras vias?",
      es: "¿Cómo se comparan las sanciones en zonas escolares con las de otras vías?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "They are higher, with doubled demerit points",
          pt: "São mais altas, com pontos de demérito em dobro",
          es: "Son más altas, con puntos de demérito duplicados"
        },
        ok: true
      },
      {
        l: "B",
        t: {
          en: "They are the same as anywhere else",
          pt: "São iguais às de qualquer lugar",
          es: "Son iguales que en cualquier parte"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "First offences are waived",
          pt: "Primeiras infrações são perdoadas",
          es: "Las primeras infracciones se perdonan"
        },
        ok: false
      }
    ],
    exp: {
      en: "School zones carry higher fines and doubled demerit points. Using a mobile phone there is an additional offence.",
      pt: "Zonas escolares têm multas mais altas e pontos de demérito em dobro. Usar celular ali é uma infração adicional.",
      es: "Las zonas escolares tienen multas más altas y puntos de demérito duplicados. Usar el móvil allí es una infracción adicional."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Towing",
    q: {
      en: "Can a learner driver tow a trailer or caravan in WA?",
      pt: "Um motorista learner pode rebocar trailer ou caravana em WA?",
      es: "¿Puede un conductor learner remolcar un remolque o caravana en WA?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Yes, small trailers only",
          pt: "Sim, apenas trailers pequenos",
          es: "Sí, solo remolques pequeños"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Yes, with the supervisor in the car",
          pt: "Sim, com o supervisor no carro",
          es: "Sí, con el supervisor en el auto"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "No — learner drivers must not tow at all",
          pt: "Não — motoristas learner não podem rebocar de forma alguma",
          es: "No — los conductores learner no pueden remolcar en absoluto"
        },
        ok: true
      }
    ],
    exp: {
      en: "Learner drivers cannot tow any trailer or caravan in WA — no exceptions for size, weight or supervision.",
      pt: "Motoristas learner não podem rebocar nenhum trailer ou caravana em WA — sem exceções de tamanho, peso ou supervisão.",
      es: "Los conductores learner no pueden remolcar ningún remolque ni caravana en WA — sin excepciones por tamaño, peso o supervisión."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Towing",
    q: {
      en: "Do towing restrictions end as soon as you get your P1 licence?",
      pt: "As restrições de reboque acabam assim que você tira a carteira P1?",
      es: "¿Las restricciones de remolque terminan al obtener la licencia P1?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Yes — P1 drivers may tow anything",
          pt: "Sim — motoristas P1 podem rebocar qualquer coisa",
          es: "Sí — los conductores P1 pueden remolcar cualquier cosa"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "No — P1 drivers still face towing restrictions",
          pt: "Não — motoristas P1 ainda têm restrições de reboque",
          es: "No — los conductores P1 aún tienen restricciones de remolque"
        },
        ok: true
      },
      {
        l: "C",
        t: {
          en: "P plates only restrict alcohol, not towing",
          pt: "A carteira P só restringe álcool, não reboque",
          es: "La licencia P solo restringe el alcohol, no el remolque"
        },
        ok: false
      }
    ],
    exp: {
      en: "Learners must not tow at all, and P1 drivers still have towing restrictions. Check the current Department of Transport guidance before towing on P plates.",
      pt: "Learners não podem rebocar, e motoristas P1 ainda têm restrições. Confira as orientações atuais do Departamento de Transportes antes de rebocar com carteira P.",
      es: "Los learners no pueden remolcar, y los conductores P1 aún tienen restricciones. Consulte la guía vigente del Departamento de Transporte antes de remolcar con licencia P."
    },
    tip: null,
    states: ["WA"]
  },
  ...
  },
  {
    ...
    cat: "Emergencies",
    q: {
      en: "An emergency vehicle approaches with lights and siren on. What should you do?",
      pt: "Um veículo de emergência se aproxima com luzes e sirene ligadas. O que fazer?",
      es: "Un vehículo de emergencia se acerca con luces y sirena. ¿Qué debe hacer?"
    },
    sign: "",
    cap: null,
    opts: [
      {
        l: "A",
        t: {
          en: "Brake hard and stop exactly where you are",
          pt: "Frear forte e parar exatamente onde está",
          es: "Frenar fuerte y detenerse exactamente donde está"
        },
        ok: false
      },
      {
        l: "B",
        t: {
          en: "Continue normally — it will find a way around",
          pt: "Seguir normalmente — ele dará um jeito de passar",
          es: "Seguir normalmente — encontrará la forma de pasar"
        },
        ok: false
      },
      {
        l: "C",
        t: {
          en: "Move safely out of its path as soon as you can",
          pt: "Sair do caminho dele com segurança assim que possível",
          es: "Apartarse de su camino con seguridad en cuanto pueda"
        },
        ok: true
      }
    ],
    exp: {
      en: "Give way: signal, move left safely and do not block its path. Avoid panic braking — a predictable, safe move helps the emergency vehicle pass sooner.",
      pt: "Dê passagem: sinalize, vá para a esquerda com segurança e não bloqueie o caminho. Evite freadas de pânico — um movimento previsível ajuda o veículo de emergência a passar mais rápido.",
      es: "Ceda el paso: señalice, muévase a la izquierda con seguridad y no bloquee el camino. Evite frenadas de pánico — un movimiento predecible ayuda al vehículo de emergencia a pasar antes."
    },
    tip: null,
    states: ["WA"]
  }
